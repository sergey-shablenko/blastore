...
const defaultStore = new memory_storage_1.MemoryStorage();
function buildSync(scheme, store = defaultStore) {
    ...
    const get = (key, defaultValue, options) => {
        try {
            ...
            const value = store.getItem((0, util_1.getFullKey)(keys, key, options?.variables));
