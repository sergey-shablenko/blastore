...
const sync_memory_storage_1 = require("./sync-memory-storage");
const util_1 = require("./util");
const subscriptions = new WeakMap();
const defaultStore = new sync_memory_storage_1.SyncMemoryStorage();
exports.buildSync = ((schema, store = defaultStore, defaultOptions) => {
    ...
    const subscribe = (key, trigger, variables) => {
        const fullKey = variables ? (0, util_1.getFullKey)(keys, key, variables) : key;
    ...
    const get = (key, defaultValue, options) => {
        ...
        if (options) {
            if (options.variables) {
                fullKey = (0, util_1.getFullKey)(keys, key, options.variables);
            }
